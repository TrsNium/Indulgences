...
defmodule Indulgences.Coordinator do
  ...
  defp execute(%Simulation{activations: [%Activation{}=activation|others], scenario: scenario, configure: nil}=_simulation) do
  ...
  defp execute(%Simulation{activations: [activation|others], scenario: scenario, configure: configure}=_simulation) do
